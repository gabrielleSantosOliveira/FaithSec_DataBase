...
CREATE TABLE `admin_users` (
  ...
  `cargo` enum('Coordenador de Enfermagem','Supervisor de Enfermagem','Gerente de Enfermagem','Diretor de Enfermagem') NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `cpf` (`cpf`)
...
INSERT INTO `admin_users` VALUES (1,'123.456.789-00','Guilherme','senha123','Diretor de Enfermagem');
...
-- Dump completed on 2025-02-20 19:06:25
